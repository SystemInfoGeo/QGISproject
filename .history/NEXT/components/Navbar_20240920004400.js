...
export default function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#28a745' }}> {/* Couleur verte */}
      <div className="container-fluid">
        <a className="navbar-brand" href="/" style={{ color: 'white', display: 'flex', alignItems: 'center' }}>
          <img src="/images/logo.jpg" alt="Logo" style={{ width: '80px', height: '80px', marginRight: '15px' }} /> {/* Taille augmentée */}
          Clean Zone
        </a>
