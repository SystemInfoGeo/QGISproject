...
export default function Navbar() {
  ...
  useEffect(() => {
    const role = localStorage.getItem('role'); // Récupère le rôle dans localStorage après la connexion
    if (role) {
      setUserRole(role); // Met à jour le rôle de l'utilisateur dans le state
    }
  }, []);
