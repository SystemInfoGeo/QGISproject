...
export default function Navbar() {
  ...
  useEffect(() => {
    // Ceci permet de forcer une mise à jour de l'interface utilisateur si nécessaire
  }, [loggedIn]); // Réexécutez lorsque loggedIn change
          ...
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li>
                  <a className="dropdown-item" onClick={() => !loggedIn && router.push('/login')} style={{ cursor: 'pointer' }}>
