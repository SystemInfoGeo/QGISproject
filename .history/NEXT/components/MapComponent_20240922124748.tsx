...
const Point_depart_fixe: LatLngTuple = [36.714666886023693, 4.045495309895148]; // Point de départ
const Point_arrivee_fixe: LatLngTuple = [36.706130742911107, 4.012404383608166]; // Point d'arrivée
...
const MapComponent: React.FC<MapProps> = ({
  ...
  const handleMarkerClick = async (index: number) => {
    ...
    if (!binIds || !binIds[index]) {
      ...
      alert(`ID de la poubelle introuvable pour ce point avec l'index ${index}`);
      return;
    }
