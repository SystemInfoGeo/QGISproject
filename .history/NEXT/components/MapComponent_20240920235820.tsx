...
const MapComponent: React.FC<MapProps> = ({
  ...
  const handleMarkerClick = async (index: number) => {
    ...
    setCollectedPoints((prev) => {
      ...
      // Vérifier que l'index est valide et que binIds contient bien l'ID
      if (!binIds || !binIds[index]) {
       ...
       const binId = binIds[index];  // Récupérer l'ID de la poubelle
       console.log(`ID de la poubelle pour ce point : ${binId}`);
