  ...
  return (
    <div className="sidebar bg-dark" style={{ height: '100vh', width: '250px', position: 'fixed' }}>
      <Nav className="flex-column p-3 text-white">
        ...
        <Nav.Link href="/admin/trash-bin" className="text-white">Gérer Points de Collecte</Nav.Link>
        <Nav.Link href="/admin/add-trash" className="text-white">Ajouter un point de collecte </Nav.Link>
        <Nav.Link href="/admin/notifications" className="text-white">Notifications</Nav.Link>
      </Nav>
    </div>
  );
};
