...
import { FaFacebook, FaWhatsapp, FaInstagram } from 'react-icons/fa'; // Importer les icônes de réseaux sociaux
          ...
          <div className="row">
            ...
            <div className="col-md-4 d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="social-icons mt-4">
                <a href="https://www.facebook.com" className="me-3" style={{ color: 'white' }}>
                  <FaFacebook size={30} />
                </a>
                <a href="https://www.whatsapp.com" className="me-3" style={{ color: 'white' }}>
                  <FaWhatsapp size={30} />
                </a>
                <a href="https://www.instagram.com" className="me-3" style={{ color: 'white' }}>
                  <FaInstagram size={30} />
                </a>
              </div>
            </div>
