    ...
    <div>
      ...
      <header className="position-relative" style={{ height: '75vh', overflow: 'hidden' }}>
        ...
        <div className="triangle-container">
          ...
          <div className="triangle-text">
            <h1 className="display-4" style={{ fontSize: '2rem', fontWeight: 'bold', color: 'white', lineHeight: '1.3', margin: '0' }}>
              La cartographie<br />
              avec les SIG<br />
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4 mb-4">
              ...
              <h3 style={{ fontSize: '1.8rem', fontWeight: 'bold', color: 'black' }}>Efficacité</h3>
            ...
            <div className="col-md-4 mb-4">
              ...
              <h3 style={{ fontSize: '1.8rem', fontWeight: 'bold', color: 'black' }}>Écologie</h3>
              <p style={{ fontSize: '1.2rem', color: '#555' }}>
            ...
            <div className="col-md-4 mb-4">
              ...
              <h3 style={{ fontSize: '1.8rem', fontWeight: 'bold', color: 'black' }}>Innovation</h3>
              <p style={{ fontSize: '1.2rem', color: '#555' }}>
      ...
      <style jsx>{
        ...
        .triangle {
          width: 0;
          height: 0;
          border-left: 400px solid rgba(0, 0, 0, 0.5);  /* Triangle avec opacité modifiée */
        ...
        .triangle-text {
          position: absolute;
          left: 20px;
          top: 150px;  /* Ajustement de la position vers le bas */
          z-index: 3;
          line-height: 1.3;  /* Réduction de l'espacement des lignes */
        }
        h2 {
          color: #2E3B4E;
        }
