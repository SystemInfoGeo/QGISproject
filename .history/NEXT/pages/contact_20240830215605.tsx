...
const Contact = () => {
  ...
  return (
    <>
      {/* Barre de navigation */}
      <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#556b2f' }}> {/* Changement de couleur ici */}
      ...
      <div className="contact-container d-flex justify-content-center align-items-center vh-100" style={{ backgroundColor: '#f5f5f5' }}> {/* Changement de couleur ici */}
        <div className="contact-form shadow-lg p-4 rounded" style={{ backgroundColor: '#2f4f4f', color: 'white', maxWidth: '900px', width: '100%' }}> {/* Changement de couleur ici */}
          <div className="row">
            {/* Formulaire à gauche */}
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    required
                    style={{ backgroundColor: '#ffffff', borderRadius: '8px', padding: '10px' }} {/* Changement de couleur ici */}
                  />
                </div>
                <div className="mb-3">
                ...
                <button type="submit" className="btn btn-success w-100" disabled={loading} style={{ color: 'white', backgroundColor: '#3cb371', borderRadius: '8px' }}> {/* Changement de couleur ici */}
