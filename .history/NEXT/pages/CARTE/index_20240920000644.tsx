...
*/
 ...
 /* useEffect(() => {
  ...
  // Fonction appelée lorsque le bouton "Terminer" est cliqué
const handleFinish = () => {
  if (data && data.points.length > 0 && allCollected) { // Assurez-vous que tous les points rouges sont collectés
    console.log('Bouton Terminer cliqué. Données:', points);
    setMessage('Collecte terminée, BRAVO!');
  } else {
    console.log('Tous les points rouges ne sont pas encore collectés.');
...
<div className={styles.container}>
  <main className={styles.main}>
    {loading ? (
      ...
      {/* Titre ajouté au-dessus de la carte */}
<h2 style={{
  fontSize: '2rem',     // Taille du titre
  color: '#333',        // Couleur du texte
  textAlign: 'center',  // Centrer le titre
  marginTop: '50px',    // Espace entre la barre de menu et le titre
  marginBottom: '20px', // Espace entre le titre et la carte
  fontWeight: 'bold'    // Rendre le texte en gras
}}>
  Chemin de Collecte Optimisé
</h2>

        <div className={styles.map}>
          {/* Appel du composant MapComponent */}
          <MapComponent
            points={points} // les points de collecte
