...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="contact-container d-flex justify-content-center align-items-center vh-100" style={{ backgroundColor: '#2E8B57' }}>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-warning w-100" disabled={loading} style={{ color: 'white', backgroundColor: '#f16624' }}>
