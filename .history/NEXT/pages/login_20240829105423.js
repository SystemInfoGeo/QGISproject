...
const Login = () => {
  ...
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#F5F5DC' }}> {/* Couleur blanc cassé */}
        <div className="container-fluid">
          <a className="navbar-brand" href="/" style={{ color: 'black', display: 'flex', alignItems: 'center' }}>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <a className="nav-link" href="/" style={{ color: 'black', marginRight: '15px' }}>Accueil</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/about" style={{ color: 'black', marginRight: '15px' }}>À propos</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/map" style={{ color: 'black', marginRight: '15px' }}>Carte</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/contact" style={{ color: 'black', marginRight: '15px' }}>Contact</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/signup" style={{ color: 'black' }}>S'inscrire</a>
              </li>
            </ul>
          </div>
        </div>
