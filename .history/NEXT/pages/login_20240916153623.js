      ...
      <div className="d-flex justify-content-center align-items-center vh-100 bg-light">
        <style jsx>{`
          ...
          .login-btn {
            background-color: #28a745;
            color: white;
            margin-top: 20px; /* Ajoute une marge entre le champ "Mot de passe" et le bouton */
          }
          .input-group {
            position: relative;
          }
          .form-control {
            background-color: #ffffff;  /* Couleur de fond modifiée */
            border: 1px solid #ced4da;
            border-radius: 0px; /* Coins droits */
            padding-left: 40px; /* Espace pour les icônes à gauche */
            padding-right: 40px;
          }
          .form-control:focus {
          ...
          .input-icon {
            ...
            color: #495057;  /* Assure que l'icône est visible */
            font-size: 1.25rem; /* Augmente la taille de l'icône */
          }
        `}</style>
