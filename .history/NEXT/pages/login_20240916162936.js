    ...
    <>
      ...
      <div className="d-flex justify-content-center align-items-center vh-100 bg-light">
        <style jsx>{`
          ...
          .input-group-text {
            background-color: #d0d0d0; /* Gris moyen clair */
          ...
          .custom-input {
            ...
            transition: border-color 0.3s ease !important; /* Transition pour un effet de changement de couleur */
          }
          .custom-input:focus {
            background-color: #ffffff !important; /* Fond blanc */
            border-color: #007bff !important; /* Bordure bleue lors du focus */
            box-shadow: 0 0 0 0.2rem rgba(38, 143, 255, 0.25) !important; /* Ombre bleue autour du champ lors du focus */
          }
        `}</style>
