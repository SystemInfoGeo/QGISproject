        ...
        <div className="row">
          <div className="col-md-4 mb-4">
            <div className="icon mb-3">
              <img src="/images/efficacite.png" alt="Efficacité" style={{ width: '50px', height: '50px' }} />
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="icon mb-3">
              <img src="/images/ecologie.png" alt="Écologie" style={{ width: '50px', height: '50px' }} />
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="icon mb-3">
              <img src="/images/innovation.png" alt="Innovation" style={{ width: '50px', height: '50px' }} />
            </div>
