...
const AdminPage = () => {
  ...
  return (
    <Container className="mt-5">
      <h1 className="text-center mb-4">Page d'administration</h1>
      ...
      {/* User Form */}
      <Form onSubmit={handleAddOrEditUser} className="mb-5">
        <Row className="mb-3">
          <Col md={6}>
        ...
        <tbody>
          {users.map(user => (
            <tr key={user.id}>
              ...
              <td>{user.role}</td>
              <td>
                <Button variant="warning" size="sm" onClick={() => handleEditUser(user)}>Modifier</Button>{' '}
