      ...
      <section className="text-center p-5 bg-light fade-in">
        ...
        <div className="row">
          <div className="col-md-4 mb-4">
            ...
            <h3 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#007bff' }}>Efficacité</h3>
          ...
          <div className="col-md-4 mb-4">
            ...
            <h3 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#28a745' }}>Écologie</h3>
            <p style={{ fontSize: '1.2rem' }}>
          ...
          <div className="col-md-4 mb-4">
            ...
            <h3 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#17a2b8' }}>Innovation</h3>
            <p style={{ fontSize: '1.2rem' }}>
