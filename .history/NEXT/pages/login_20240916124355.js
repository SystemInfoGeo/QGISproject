...
import { faUser, faEye, faEyeSlash } from '@fortawesome/free-solid-svg-icons'; // Importer l'icône utilisateur et les icônes "œil"
    ...
    <>
      ...
      <div className="d-flex justify-content-center align-items-center vh-100 bg-light">
        <style jsx>{`
          ...
          .password-input {
            width: 100%;
            padding-right: 40px;  /* Laisser de l'espace pour l'icône œil */
          }
          .toggle-password {
            position: absolute;
            top: 50%;
        ...
        <div className="login-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3 password-container">
              ...
              />
              <FontAwesomeIcon
                icon={showPassword ? faEyeSlash : faEye}  // Bascule entre les icônes "œil" et "œil barré"
                className="toggle-password"
                onClick={() => setShowPassword(!showPassword)}  // Bascule l'état de visibilité du mot de passe
              />
            </div>
