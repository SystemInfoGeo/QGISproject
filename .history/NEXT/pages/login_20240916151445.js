...
import { faUser, faEnvelope, faLock } from '@fortawesome/free-solid-svg-icons';  // Import des icônes nécessaires
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <div className="input-group">
                <FontAwesomeIcon icon={faEnvelope} className="input-icon" /> {/* Icone à l'intérieur du champ */}
                <input
                  type="email"
            ...
            <div className="mb-3">
              ...
              <div className="input-group">
                <FontAwesomeIcon icon={faLock} className="input-icon" /> {/* Icone à l'intérieur du champ */}
                <input
