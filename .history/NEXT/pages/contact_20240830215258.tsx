              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    required
                    style={{ backgroundColor: '#f0f0f0', borderRadius: '8px', padding: '10px' }}
                  />
                </div>
                <div className="mb-3">
                ...
                <button type="submit" className="btn btn-success w-100" disabled={loading} style={{ color: 'white', backgroundColor: '#28a745', borderRadius: '8px' }}>
