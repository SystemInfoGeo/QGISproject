  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setCollectedPoints(pointsRes.data.collected_points);
        setUncollectedPoints(pointsRes.data.uncollected_points);
      } catch (error) {
          ...
          <div className="col-md-3">
            <div className="dashboard-card bg-warning text-white">
              <div className="card-body">
                ...
                <p className="card-text">{collectedPoints}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-3">
            <div className="dashboard-card bg-secondary text-white">
              <div className="card-body">
                ...
                <p className="card-text">{uncollectedPoints}</p>
              </div>
            </div>
          </div>
        </div>
