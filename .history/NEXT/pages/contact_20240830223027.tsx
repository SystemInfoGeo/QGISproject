          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              <li className={`nav-item ${router.pathname === '/' ? 'active' : ''}`}>
                <a className="nav-link" href="/" style={{ marginRight: '30px' }}>Accueil</a>
              </li>
              <li className={`nav-item ${router.pathname === '/about' ? 'active' : ''}`}>
                <a className="nav-link" href="/about" style                <a className="nav-link" href="/about" style={{ marginRight: '30px' }}>À propos</a>
              </li>
              <li className={`nav-item ${router.pathname === '/map' ? 'active' : ''}`}>
                <a className="nav-link" href="/map" style={{ marginRight: '30px' }}>Carte</a>
              </li>
              <li className={`nav-item ${router.pathname === '/contact' ? 'active' : ''}`}>
                <a className="nav-link" href="/contact" style={{ marginRight: '30px' }}>Contact</a>
              </li>
              <li className={`nav-item ${router.pathname === '/signup' ? 'active' : ''}`}>
                <a className="nav-link" href="/signup" style={{ marginRight: '30px' }}>S'inscrire</a>
              </li>
              <li className={`nav-item ${router.pathname === '/login' ? 'active' : ''}`}>
                <a className="btn btn-light" href="/login" style={{ marginRight: '30px' }}>Se connecter</a>
              </li>
            </ul>
          </div>
        </div>
