      ...
      <div className="d-flex justify-content-center align-items-center vh-100 bg-light">
        <style jsx>{`
          ...
          .form-control {
            ...
            padding-right: 40px;
            border-radius: 8px;  /* Ajouter des coins arrondis sur tous les côtés */
            border: 1px solid #ced4da; /* Bordure pour l'uniformité */
          }
          .input-group .form-control {
            padding-right: 2.5rem; /* Espacement pour l'icône à l'intérieur du champ */
            border-radius: 8px; /* Coins arrondis pour correspondre à l'email */
          }
          .toggle-password {
            position: absolute;
            right: 0.75rem;
            ...
            border: none; /* Supprimer la bordure pour éviter tout conflit visuel */
          }
          .form-label {
            font-weight: bold;
            margin-bottom: 8px;
