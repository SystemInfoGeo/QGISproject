...
const AdminPage = () => {
  ...
  const handleAddUser = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('/api/users', { email, firstName, lastName, role, password });
  ...
  const handleUpdateUser = async (id) => {
    try {
      const response = await axios.put(`/api/users/${id}`, { email, firstName, lastName, role });
