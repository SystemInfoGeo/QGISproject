...
const Contact = () => {
  ...
  return (
    <>
      {/* Barre de navigation */}
      <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#808080' }}> {/* Couleur de la page de connexion */}
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              <li className={`nav-item ${router.pathname === '/' ? 'active' : ''}`}>
                <a className="nav-link" href="/" style={{ marginRight: '30px', color: router.pathname === '/' ? '#000' : '#FFF' }}>Accueil</a>
              </li>
              <li className={`nav-item ${router.pathname === '/about' ? 'active' : ''}`}>
                <a className="nav-link" href="/about" style={{ marginRight: '30px', color: router.pathname === '/about' ? '#000' : '#FFF' }}>À propos</a>
              </li>
              <li className={`nav-item ${router.pathname === '/map' ? 'active' : ''}`}>
                <a className="nav-link" href="/map" style={{ marginRight: '30px', color: router.pathname === '/map' ? '#000' : '#FFF' }}>Carte</a>
              </li>
              <li className={`nav-item ${router.pathname === '/contact' ? 'active' : ''}`}>
                <a className="nav-link" href="/contact" style={{ marginRight: '30px', color: router.pathname === '/contact' ? '#000' : '#FFF' }}>Contact</a>
              </li>
              <li className={`nav-item ${router.pathname === '/signup' ? 'active' : ''}`}>
                <a className="nav-link" href="/signup" style={{ marginRight: '30px', color: router.pathname === '/signup' ? '#000' : '#FFF' }}>S'inscrire</a>
              </li>
              <li className={`nav-item ${router.pathname === '/login' ? 'active' : ''}`}>
                <a className="btn btn-light" href="/login" style={{ marginRight: '30px', backgroundColor: router.pathname === '/login' ? '#FFF' : '#ccc' }}>Se connecter</a>
              </li>
            </ul>
          </div>
        </div>
