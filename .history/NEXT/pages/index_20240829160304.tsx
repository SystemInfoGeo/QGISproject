            ...
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a className="dropdown-item" href="https://www.facebook.com/YourPage" target="_blank">Facebook</a></li>
                  <li><a className="dropdown-item" href="mailto:yourmail@example.com">Gmail</a></li>
                  <li><a className="dropdown-item" href="tel:+213668541364">Téléphone : 0668 54 13 64</a></li>
                </ul>
              </li>
              <li className="nav-item">
