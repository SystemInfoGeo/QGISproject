...
export default function Home() {
  ...
  // Utilisation du hook personnalisé pour vérifier l'authentification de l'utilisateur
  const authenticated = useAuth(); 

  // Fonction qui gère l'accès à la page de collecte
  const handleAccessCollectClick = () => {
    if (authenticated) {
      // Si l'utilisateur est authentifié, il est redirigé vers la page de collecte
      router.push('/collect');
    } else {
      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <ul>
            ...
            <li><a href="#" onClick={handleAccessCollectClick}>Accès Collecte</a></li> {/* Bouton pour accéder à la collecte */}
