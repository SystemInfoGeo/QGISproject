  ...
  return (
    <div>
      ...
      <header className="position-relative" style={{ height: '75vh', overflow: 'hidden' }}>
        ...
        {/* Triangle avec le titre */}
        <div className="triangle-container">
          <div className="triangle"></div>
          <div className="triangle-text">
            <h1 className="display-4" style={styles.triangleText}>
      ...
      <style jsx>{`
        ...
        .triangle {
          width: 0;
          height: 0;
          border-left: 400px solid rgba(0, 0, 0, 0.6);  /* Triangle semi-transparent */
          border-top: 400px solid transparent;
          border-bottom: 400px solid transparent;
          border-right: 3px solid white; /* Bordure pour un effet plus distinct */
        }
        .triangle-text {
          position: absolute;
          left: 50px;
