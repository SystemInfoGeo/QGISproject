...
const Login = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg" style={{ backgroundColor: '#90a290' }}>
        <div className="container-fluid">
          <a className="navbar-brand" href="/" style={{ color: 'white', display: 'flex', alignItems: 'center' }}>
            {/* Ajoutez l'image du logo ici */}
            <img src="/path/to/your/logo.png" alt="Logo" style={{ width: '30px', height: '30px', marginRight: '10px' }} />
            Clean Zone
          </a>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <a className="nav-link" href="/" style={{ color: 'white' }}>Accueil</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/about" style={{ color: 'white' }}>À propos</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/map" style={{ color: 'white' }}>Carte</a>
              </li>
              <li className="nav-item">
