    ...
    <div>
      ...
      <header className="position-relative" style={{ height: '75vh', overflow: 'hidden' }}>
        ...
        <div className="position-absolute top-50 start-50 translate-middle text-center text-white" 
             style={{ zIndex: 2, background: 'rgba(0, 0, 0, 0.5)', padding: '2rem', borderRadius: '8px' }}>
          <h1 className="display-4" style={{ fontSize: '2.8rem', fontWeight: 'bold', textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
            La cartographie avec les SIG pour une collecte des déchets plus verte et efficace
          </h1>
        </div>
          ...
          <div className="row">
            <div className="col-md-4 mb-4">
              <div className="icon mb-3">
                <img src="/images/efficacite.png" alt="Efficacité" style={{ width: '120px', height: '120px', transition: 'all 0.3s' }} />
              </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="icon mb-3">
                <img src="/images/ecologie.png" alt="Écologie" style={{ width: '120px', height: '120px', transition: 'all 0.3s' }} />
              </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="icon mb-3">
                <img src="/images/innovation.png" alt="Innovation" style={{ width: '120px', height: '120px', transition: 'all 0.3s' }} />
              </div>
