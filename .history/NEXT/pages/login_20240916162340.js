      ...
      <div className="d-flex justify-content-center align-items-center vh-100 bg-light">
        <style jsx>{`
          ...
          .form-control {
            ...
            border: 1px solid #ced4da;
            border-left: 0;
            transition: border-color 0.3s ease; /* Transition pour un effet de changement de couleur */
          }
          .form-control:focus {
            background-color: #ffffff; /* Fond blanc */
            border-color: #007bff; /* Bordure bleue lors du focus */
            box-shadow: 0 0 0 0.2rem rgba(38, 143, 255, 0.25); /* Ombre bleue autour du champ lors du focus */
          }
        `}</style>
