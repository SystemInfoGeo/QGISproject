    ...
    <div>
      ...
      <header className="position-relative" style={{ height: '75vh', overflow: 'hidden' }}>
        ...
        <div className="triangle-container">
          ...
          <div className="triangle-text">
            <h1 className="display-4" style={{ fontSize: '1.8rem', fontWeight: 'bold', color: 'white', lineHeight: '1.5rem' }}>
              La cartographie avec les SIG<br/> pour une collecte des déchets <br/> plus verte et efficace
            </h1>
          </div>
        </div>
      ...
      <style jsx>{`
        ...
        .triangle {
          width: 0;
          height: 0;
          border-left: 350px solid rgba(0, 0, 0, 0.5);  /* Triangle avec opacité modifiée */
        ...
        .triangle-text {
          ...
          top: 100px;
          z-index: 3;
          line-height: 1.2; /* Réduction de l'espacement entre les lignes pour tenir dans le triangle */
        }
        h2 {
          color: #2E3B4E;
        }
