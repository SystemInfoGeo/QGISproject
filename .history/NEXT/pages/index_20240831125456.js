...
export default function Accueil() {
  ...
  return (
    <div>
      ...
      {/* Vidéo de fond avec découpe triangulaire */}
      <header className="position-relative" style={{ height: '75vh', overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
        <div className="video-container" style={{ flex: '1', position: 'relative' }}>
          <video ref={videoRef} autoPlay loop muted={isMuted} className="w-100 h-100" style={{ objectFit: 'cover', clipPath: 'polygon(0 0, 70% 0, 30% 100%, 0 100%)' }}>
            <source src="/videos/background.mp4" type="video/mp4" />
            Votre navigateur ne prend pas en charge la vidéo.
          </video>
        </div>
        <div className="position-relative text-white fade-in" style={{ zIndex: 2, padding: '2rem', background: 'rgba(0, 0, 0, 0.6)', borderRadius: '8px', marginLeft: '-20%', flex: '1', maxWidth: '40%' }}>
        ...
        <div className="row">
          <div className="col-md-4 mb-4">
            <div className="icon mb-3">
              <img src="/images/efficacite.png" alt="Efficacité" style={{ width: '100px', height: '100px' }} />
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="icon mb-3">
              <img src="/images/ecologie.png" alt="Écologie" style={{ width: '100px', height: '100px' }} />
            </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="icon mb-3">
              <img src="/images/innovation.png" alt="Innovation" style={{ width: '100px', height: '100px' }} />
            </div>
