  ...
  return (
    <div>
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <a className="nav-link text-white" href="/CARTE">Carte</a>
              </li>
              <li className="nav-item">
                <a className="nav-link text-white" href="/contact">Contact</a>
              </li>
              <li className="nav-item">
                <a className="nav-link text-white" href="/signup">S'inscrire</a>
              </li>
              <li className="nav-item">
                <a className="nav-link text-white" href="/login">Se connecter</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <header className="position-relative">
        ...
        <div className="position-absolute top-50 start-50 translate-middle text-center text-white p-4" style={{ zIndex: 2, background: 'rgba(0, 0, 0, 0.5)', borderRadius: '8px' }}>
