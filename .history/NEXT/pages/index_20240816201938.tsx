      ...
      <section className={styles.testimonials}>
        ...
        <div className={styles.testimonialList}>
          <div className={styles.testimonial}>
            <p>"La solution proposée a transformé notre gestion des déchets de manière incroyable!"</p>
            <h4>Jean Dupont</h4>
            <span>Directeur de la collecte</span>
          </div>
          <div className={styles.testimonial}>
            <p>"Un service efficace et professionnel qui répond à nos besoins en temps réel."</p>
            <h4>Marie Durand</h4>
