    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <section className={styles.section}>
          <div>
            <h2>Pourquoi optimiser la collecte des déchets ?</h2>
            <p>
        ...
        <section className={styles.section}>
          <div>
            ...
            <p>
De plus, les SIG permettent une analyse approfondie des données sur les volumes de déchets produits par différentes zones. Cette information est essentielle pour ajuster les fréquences de collecte en fonction des besoins réels, évitant ainsi les surcharges de poubelles et les déchets non ramassés. 
            </p>
            <p>QGIS offre également des fonctionnalités de suivi en temps réel, permettant aux gestionnaires de réagir rapidement en cas de problème, comme une panne de camion ou un itinéraire bloqué.     L'utilisation de ces outils améliore la transparence et la communication entre les différents acteurs impliqués dans la gestion des déchets, des opérateurs de collecte aux décideurs municipaux. En fin de compte, les SIG et QGIS contribuent à une gestion plus durable et efficace des déchets, réduisent les coûts opérationnels, améliorent la propreté urbaine et minimisent l'impact environnemental, tout en assurant un service de meilleure qualité pour les citoyens.
            </p>
          </div>
