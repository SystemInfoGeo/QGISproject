      ...
      <section className="text-center p-5 bg-light fade-in">
        ...
        <div className="row">
          <div className="col-md-4 mb-4">
            <div className="icon mb-3 bg-primary text-white p-3 rounded">
          ...
          <div className="col-md-4 mb-4">
            <div className="icon mb-3 bg-success text-white p-3 rounded">
          ...
          <div className="col-md-4 mb-4">
            <div className="icon mb-3 bg-info text-white p-3 rounded">
