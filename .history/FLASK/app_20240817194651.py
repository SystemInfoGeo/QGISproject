...
# Importez la classe Config depuis config.py
from config import Config

# Importez le Blueprint d'authentification
from auth import auth

# Importez CORS depuis flask_cors
...
CORS(app)  # Permet à toutes les origines d'accéder à votre serveur
