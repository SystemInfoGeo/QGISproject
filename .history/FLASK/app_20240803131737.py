...
# ici on va ajouter une variable qui va nous permettre de suivre l'etat des données( pour l'envoi des données()de l'interface collect vers flask pour les sauvegrader)
saved_data = None
data_saved = False
