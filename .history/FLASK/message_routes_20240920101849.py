...
def list_messages():
    try:
        ...
        # Assurez-vous de bien renvoyer la liste des messages dans la réponse
        return jsonify({
            "messages": messages_data,  # La liste des messages formatés
            "pending_messages": 5,      # Exemple d'information supplémentaire
            "total_messages": messages.total,  # Total des messages
            "current_page": messages.page,     # Page actuelle
            "total_pages": messages.pages      # Nombre total de pages
