...
def upgrade():
    # On vérifie si les colonnes existent déjà avant de les ajouter
    with op.batch_alter_table('user', schema=None) as batch_op:
        # Ajoute les colonnes uniquement si elles n'existent pas déjà
    ...
    # Cette étape ne sera exécutée que si ces colonnes étaient nulles au départ
