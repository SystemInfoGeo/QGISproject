...
def send_email(to_email, subject, message):
    ...
    smtp_port = 587
    sender_email = "ton_adresse_gmail@gmail.com"
    password = "ton_mot_de_passe_application"  # Utilise ton mot de passe d'application
...
def get_user_messages():
    email = get_jwt_identity()  # Récupérer l'email de l'utilisateur connecté via JWT
    ...
    try:
        ...
        # Rechercher les messages de l'utilisateur connecté avec cet email
