...
def admin_profile():
    # Simule l'obtention de l'administrateur connecté
    # Dans une vraie application, cela viendrait de l'utilisateur authentifié
    admin_id = 1  # ID simulé, en pratique tu utiliserais l'ID de session JWT ou autre méthode d'authentification
...
def change_password():
    ...
    return jsonify({"msg": "Mot de passe non fourni"}), 400
