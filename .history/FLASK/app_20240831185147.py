...
from check_login import check_login_bp
...
@jwt_required()  # Exige que l'utilisateur soit authentifié via JWT
def receive_data():
    claims = get_jwt()  # Obtenez les revendications (claims) du JWT
    role = claims.get("role")  # Récupérez le rôle de l'utilisateur

    # Vérifiez si l'utilisateur a le rôle "agent_collecte"
