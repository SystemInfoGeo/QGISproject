...
def user_profile():
    ...
    # Extraire l'email de l'utilisateur à partir du dictionnaire JWT
    current_user_email = current_user.get('email')  # Utiliser .get('email') pour récupérer uniquement l'email
