...
def admin_profile():
    ...
    # Extraire uniquement l'email de l'utilisateur à partir du dictionnaire JWT
    current_user_email = current_user.get('email')  # Utilise .get('email') pour obtenir uniquement l'email

    print(f"Utilisateur connecté : {current_user_email}")  # Log pour débogage
