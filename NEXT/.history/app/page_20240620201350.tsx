    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          ...
          <Image src="/images/statistics.jpg" alt="Statistiques de collecte" width={600} height={400} />
        </section>
        <section className={styles.section}>
          <h2>Notifications</h2>
          <p>Recevez des notifications en temps réel sur l'état des collectes.</p>
          <Image src="/images/notifications.jpg" alt="Notifications" width={600} height={400} />
        </section>
      </main>
