import { useNavigation } from 'next/navigation'; // Utilisez useNavigation au lieu de useRouter pour les composants serveur
import Image from 'next/image';
import styles from './page.module.css';

export default function Home() {
  const router = useNavigation(); // Utilisation de useNavigation à la place de useRouter
