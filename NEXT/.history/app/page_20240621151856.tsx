import { useNavigation } from 'next/navigation'; // Utilise useNavigation au lieu de useRouter
import Image from 'next/image';
import styles from './page.module.css';

export default function Home() {
  const navigation = useNavigation(); // Utilise useNavigation au lieu de useRouter

  const navigateToCollect = () => {
    navigation.navigate('/collect'); // Utilise navigate au lieu de push
  };
