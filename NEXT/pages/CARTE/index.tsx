...
export default function Collect() {
    ...
    const fetchPath = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Extraire et mettre à jour les itinéraires ORS
          const itinerairesORS = result.itineraires_ors.map((itinerary: any) =>
            itinerary.routes.map((route: any) => route.geometry)
          ).flat();
  ...
  // Fonction pour gérer la collecte terminée
  ...
  // Fonction appelée pour fermer le message de fin de collecte
